...
class PromptTemplates:
    ...
    # ------------------------------------------------------------------
    SYSTEM_PROMPT = (
        "You are an expert Django test engineer specializing in pytest."\
        " Your role is to generate high-quality, comprehensive tests based on natural language specifications.\n\n"\
        "Key principles:\n"\
